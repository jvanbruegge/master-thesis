...
\item{an infinite\footnote{$\aleph_0 \le bd_F$}, regular\footnote{the bound is equal to its own cofinality, ie is the smallest cardinal of all subsets of the set\label{ftn:regular}} and well-ordered cardinal number $bd_F$}
